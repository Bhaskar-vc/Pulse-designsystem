...
import { sizes } from '@pulse-ds/ui/core';
import {
  VcCheckItem,
  VcCheckgroupChangeEvent,
  VcCheckboxChangeEvent,
} from './vc-checkbox.interface';
import { VcFormControl } from '@pulse-ds/ui/core';
import { UniqueIdService } from '@pulse-ds/ui/core';

@Component({
    standalone: true,
    selector: 'vc-checkbox',
    imports: [CommonModule],
    templateUrl: './vc-checkbox.component.html',
    styleUrl: './vc-checkbox.component.scss',
    providers: [
        {
