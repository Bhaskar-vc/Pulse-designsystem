...
import { UniqueIdService, VcFormControl } from '@pulse-ds/ui/core';
  ...
  implements OnInit, OnDestroy, AfterContentInit, VcFormControl
{
  ...
  getSelectBtnClass() {
    return selectBtnVariants({
      type:            this.type as any,
      widthFitContent: this.widthFitContent,
