...
import { TooltipV2Trigger, TooltipV2Placement } from './tooltip-v2.enums';
...
export class VcTooltipV2 implements OnInit, OnDestroy{
  @Input() trigger: `${TooltipV2Trigger}` = TooltipV2Trigger.HOVER;
  @Input() placement: `${TooltipV2Placement}` = TooltipV2Placement.BOTTOM;
